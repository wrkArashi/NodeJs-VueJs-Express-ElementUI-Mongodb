			...
			<el-tabs value="basic" type="border-card">
				<el-tab-pane label="基本信息" name="basic">
					...
					<el-form-item label="头像">
						<el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false" :on-success="res => $set(model,'avatar',res.url)"
					...
					<el-form-item label="Banner">
						<el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false" :on-success="res => $set(model,'banner',res.url)"
						 :before-upload="beforeAvatarUpload" :headers="getAuthHeaders()">
	...
	export default {
		...
		methods: {
			...
			async fetch() {
				...
				// this.model = res.data
				//先把this.model的值放进去，再把res.data有的值替换this.model
