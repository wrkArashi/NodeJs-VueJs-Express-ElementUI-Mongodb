module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = ["体验服停机更新公告", "典韦伤害异常说明", "专属】“游戏礼品站”购买“小乔-青蛇”、“阿轲-节奏热浪”抽免单活动", "活动开启，最高可暴击1000荣耀积分", "晶皮肤即将登场，限时语音包同步上线", "茶里×王者荣耀 | 跨界出击，给新年加buff！", "团选拔开始，助你心爱的主播出道！", "计赏析第8期，赏花赏月赏佳人~", "，天生耀眼】 MINTYGREEN·周生生×王者荣耀 峡谷四美手链上市", "蹄疾，一“夜”看尽长安花", "体验服停机更新公告", "典韦伤害异常说明", "全服不停机更新公告", "体验服S22赛季王者段位专属拖尾奖励发放", "体验服停机更新公告", "专属】“游戏礼品站”购买“小乔-青蛇”、“阿轲-节奏热浪”抽免单活动", "活动开启，最高可暴击1000荣耀积分", "晶皮肤即将登场，限时语音包同步上线", "·集群英筹庆典】活动开启公告", "光 FMVP定制皮肤即将登场，应援冬冠参与活动得好礼", "KPL王者荣耀职业联赛赛制升级，全新对抗一触即发！", "共度荣耀！2020王者荣耀冬季冠军杯暨年度颁奖典礼圆满落幕", "，2020王者荣耀年度奖项获奖名单揭晓！", "者荣耀冬季冠军杯总决赛圆满落幕，南京Hero久竞加冕为王！", "年终决战！2020王者荣耀冬季冠军杯总决赛今日17:00线上直播！"]
        const newsList = newsTitles.map(title => {
            //.slice表示从cats数组中复制一份进行排序
        ...
        await Article.deleteMany({})//以任意条件查询删除
    ...
    router.get('/news/list', async (req, res) => {
        ...
        //热门分类是独立于其他四个分类的
        //subCats里是新闻公告活动赛事4个分类里的id
        //在文章集合中找出categories=4个分类id的所有文档
    ...
    router.get('/heroes/list', async (req, res) => {
        ...
        const cats = await Category.aggregate([
            ...
            { $match: { parent: parent._id } },
            {
                $lookup: {
                    from: 'heroes',//关联哪个集合
                    localField: '_id',//指定heroes集合里的字段名
