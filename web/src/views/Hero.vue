			...
			<swiper>
				<swiper-slide>
					<div>
						<div class="p-3 bg-white border-bottom">
							...
							<div class="skills bg-white mt-4">
								<div class="d-flex jc-around">
									<img class="icon" :class="{active:currentSkillsIndex === index}" @click="currentSkillsIndex=index" v-for="(item,index) in model.skills" :key="index" :src="item.icon">
								</div>
						...
						<m-card plain icon="shipin" title="出装推荐" class="hero-items">
						...
						<m-card plain icon="shipin" title="使用技巧">
							<p class="m-0">{{model.usageTips}}</p>
						</m-card>
						<m-card plain icon="shipin" title="对抗技巧">
							<p class="m-0">{{model.battleTips}}</p>
						</m-card>
						<m-card plain icon="shipin" title="团战思路">
							<p class="m-0">{{model.teamTips}}</p>
						</m-card>
						<m-card plain icon="shipin" title="英雄关系">
